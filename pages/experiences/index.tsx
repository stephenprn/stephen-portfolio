...
const EXPERIENCES: IExperience[] = [
    ...
    },
    {
        ...
        summary: [
            'Développement d\'applications web pour divers clients publics et privés.',
        ],
        skills: [
            'AngularJS',
            'Angular',
    ...
    },
    {
        ...
        summary: [
            'Mise en place de l\'environnement de développement mobile dans l\'entreprise : Ionic & AngularJS.',
        ],
        skills: [
            'AngularJS',
            'Ionic',
        ...
        <div className='cards-list'>
            {
                EXPERIENCES.map((experience, index) => (
                    <div key={index} className={classes["experience-container"]} onMouseEnter={() => {
                        setIndexHighlighted(index);
                    }} onMouseLeave={() => {
                        setIndexHighlighted(null);
                    }}> <Experience {...experience} last={index === EXPERIENCES.length - 1} highlighted={index === indexHighlighted} faded={
